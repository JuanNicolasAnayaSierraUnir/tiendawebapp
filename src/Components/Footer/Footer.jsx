        ...
        <footer className=" text-center">
            <div className="overlay">
                <div className="rounded-social-buttons mt-3">
                    <a className="social-button facebook" href="https://www.facebook.com/" target="_blank" rel="noreferrer">
                        <svg fill="white" xmlns="http://www.w3.org/2000/svg" height="25" width="25" viewBox="0 0 320 512">
                    ...
                    <a className="social-button twitter" href="https://www.twitter.com/" target="_blank" rel="noreferrer">
                        <svg className="twitter" xmlns="http://www.w3.org/2000/svg" height="25" width="25" viewBox="0 0 512 512">
                    ...
                    <a className="social-button tiktok" href="https://www.tiktok.com/" target="_blank" rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" height="25" width="25" viewBox="0 0 448 512">
